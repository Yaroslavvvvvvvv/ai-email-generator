...
**3. AI Development Report** — головна частина завдання за словами замовника.
Сировина зібрана в `docs/ai-report.md`, треба довести до чистового вигляду
російською мовою.

**4. Дрібне:**
- прибрати тестових користувачів `tester+…@example.com` із Supabase;
- **прокрутити секретний ключ Supabase** (`Project Settings → API Keys → Rotate`) —
  він засвітився в стенограмі сесії, у репозиторій не потрапляв;
- перевірити сторінку Pricing під час виходу з преміуму (шлях є, руками не тиснутий).
